...
> Quantidade de Tickets por Usuário: `$if[$getUserVar[outros-ticket;$serverOwner;$guildID]==]1$elseif[$getUserVar[outros-ticket;$serverOwner;$guildID]!=]$getUserVar[outros-ticket;$serverOwner;$guildID]$endif`;1]
